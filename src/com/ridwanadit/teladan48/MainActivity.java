...
import com.ridwanadit.teladan48.lib.TabCompatActivity;
import com.ridwanadit.teladan48.lib.TabHelper;
...
public class MainActivity extends TabCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        CompatTab videosTab = tabHelper.newTab("feed")
                .setText(R.string.tab_blog)
                .setIcon(R.drawable.ic_tab_videos)
                .setTabListener(new InstantiatingTabListener(this, FeedFragment.class));
